    ...
    public class DatabaseInitializer : IDatabaseInitializer
    {
        ...
        public async Task SeedAsync()
        {
            ...
            if (!await _context.Users.AnyAsync())
            {
                ...
                await CreateUserAsync("admin", "tempP@ss123", "Inbuilt Administrator", "admin@technologysarl.com", "+1 (123) 000-0000", new string[] { adminRoleName });
                await CreateUserAsync("user", "tempP@ss123", "Inbuilt Standard User", "user@technologysarl.com", "+1 (123) 000-0001", new string[] { userRoleName });
            ...
            //    {
            //        Name = "Ali Ahmad",
            //        Email = "contact@technologysarl.com",
            //        Gender = Gender.Male,
            ...
            //    {
            //        Name = "Ali Sami Ahmad",
            //        Email = "alisamiahmad@gmail.com",
            //        PhoneNumber = "96171226174",
            //        Address = "Jlala Rue Matahen",
            //        City = "Lebanon",
            //        Gender = Gender.Male,
            //        DateCreated = DateTime.UtcNow,
            //        DateModified = DateTime.UtcNow
