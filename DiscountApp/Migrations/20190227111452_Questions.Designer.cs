...
namespace DiscountApp.Migrations
{
    ...
    [Migration("20190227111452_Questions")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAL.Models.Questions.OnlineShopping", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("OnlineShopping");
                });

            modelBuilder.Entity("DAL.Models.Questions.PreferredStyle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("PreferredStyle");
                });

            modelBuilder.Entity("DAL.Models.Questions.ProductType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("DAL.Models.Questions.Question", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("DAL.Models.Questions.QuestionCategory", b =>
                {
            ...
            modelBuilder.Entity("DAL.Models.Questions.QuestionOnlineShopping", b =>
                {
                    b.Property<int>("QuestionId");

                    b.Property<int>("OnlineId");

                    b.HasKey("QuestionId", "OnlineId");

                    b.HasIndex("OnlineId");

                    b.ToTable("QuestionOnlineShopping");
                });

            modelBuilder.Entity("DAL.Models.Questions.QuestionPreferredStyle", b =>
                {
                    b.Property<int>("QuestionId");

                    b.Property<int>("PreferredId");

                    b.HasKey("QuestionId", "PreferredId");

                    b.HasIndex("PreferredId");

                    b.ToTable("QuestionPreferredStyle");
                });

            modelBuilder.Entity("DAL.Models.Questions.QuestionProductType", b =>
                {
                    b.Property<int>("QuestionId");

                    b.Property<int>("ProductTypeId");

                    b.HasKey("QuestionId", "ProductTypeId");

                    b.HasIndex("ProductTypeId");

                    b.ToTable("QuestionProductType");
                });

            modelBuilder.Entity("DAL.Models.Questions.QuestionShoppingTime", b =>
                {
                    b.Property<int>("QuestionId");

                    b.Property<int>("ShoppingTimeId");

                    b.HasKey("QuestionId", "ShoppingTimeId");

                    b.HasIndex("ShoppingTimeId");

                    b.ToTable("QuestionShoppingTime");
                });

            modelBuilder.Entity("DAL.Models.Questions.ShoppingTime", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("DAL.Models.Questions.QuestionCategory", b =>
                {
                    ...
                    b.HasOne("DAL.Models.Questions.Question", "Question")
                        .WithMany("QuestionCategories")
            ...
            modelBuilder.Entity("DAL.Models.Questions.QuestionOnlineShopping", b =>
                {
                    b.HasOne("DAL.Models.Questions.OnlineShopping", "OnlineShopping")
                        .WithMany("QuestionOnlineShoppings")
            ...
            modelBuilder.Entity("DAL.Models.Questions.QuestionPreferredStyle", b =>
                {
                    b.HasOne("DAL.Models.Questions.PreferredStyle", "PreferredStyle")
                        .WithMany("QuestionPreferredStyles")
            ...
            modelBuilder.Entity("DAL.Models.Questions.QuestionProductType", b =>
                {
                    b.HasOne("DAL.Models.Questions.ProductType", "ProductType")
                        .WithMany("QuestionProductTypes")
            ...
            modelBuilder.Entity("DAL.Models.Questions.QuestionShoppingTime", b =>
                {
                    b.HasOne("DAL.Models.Questions.Question", "Question")
                        .WithMany("QuestionShoppingTimes")
                        .HasForeignKey("QuestionId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("DAL.Models.Questions.ShoppingTime", "ShoppingTime")
                        .WithMany("QuestionShoppingTimes")
                        .HasForeignKey("ShoppingTimeId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
