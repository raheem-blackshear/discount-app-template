                ...
                if (data == null) {
                    data = [
                        ...
                        { "completed": false, "important": true, "name": "Do a quick how-to writeup", "description": "" },
                        {
                            ...
                            " using aspnet-core/angular5. The tutorial will focus on getting productive with the Discount right away rather than the details on how and why they work so audience can get onboard quickly."
                        },
                    ];
                }
