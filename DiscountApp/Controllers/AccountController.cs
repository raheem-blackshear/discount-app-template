    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> UpdateUser(string id, [FromBody] UserEditViewModel user)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (Utilities.GetUserId(this.User) == id && (appUser.Email != user.Email || !string.IsNullOrWhiteSpace(user.NewPassword)))
                {
        ...
        [HttpPost("contact")]
        [Authorize(Authorization.Policies.ManageAllUsersPolicy)]
        public async Task<IActionResult> Contact([FromBody] ContactViewModels contact)
        {
